...
export const deleteItemInDynamoTable: APIGatewayProxyHandler = async (event: APIGatewayProxyEvent & Body, _context) => {
...
export const handler = middy(deleteItemInDynamoTable)
